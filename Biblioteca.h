...
public:
	...
	int buscarCodAlunoNome(string nomeAluno); // funçao visualizar cadastro aluno fornecendo cod aluno
	...
	int buscarCodLivroNome(string nomeLivro);// funçao procurar livro
