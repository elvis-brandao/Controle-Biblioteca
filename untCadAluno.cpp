...
{
	MessageBoxA(NULL, "Favor preencher os campos MATRÍCULA e NOME", "Cadastro de Aluno", MB_OK);
}
else
{
AnsiString mat, nome;
...
if (Key < 8 || (Key > 8 && Key < 13) || (Key > 13 && Key < 48) || Key > 57)
{
        ...
        MessageBoxA(NULL, "Favor digitar somente números", "CadastrarAlunos", MB_OK);
}
}
//---------------------------------------------------------------------------
